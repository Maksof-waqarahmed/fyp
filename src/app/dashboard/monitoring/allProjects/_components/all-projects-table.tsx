...
function statusBadge(status: HTTPStatus | null) {
    ...
    const map: Record<HTTPStatus, { label: string; className: string }> = {
        UP: { label: "UP", className: "bg-green-100 text-green-700 border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-800" },
        REDIRECT: { label: "REDIRECT", className: "bg-yellow-100 text-yellow-700 border-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-400 dark:border-yellow-800" },
        CLIENT_ERROR: { label: "CLIENT ERR", className: "bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-900/30 dark:text-orange-400 dark:border-orange-800" },
        DOWN: { label: "DOWN", className: "bg-red-100 text-red-700 border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800" },
...
function ExpandedEndpoints({ projectId }: { projectId: string }) {
    ...
    return (
        <div className="px-6 pb-4 pt-2 bg-muted/30 border-t">
            ...
            <Table className="rounded border overflow-hidden text-sm">
                ...
                <TableBody>
                    {endpoints.map((ep) => (
                        <TableRow key={ep.id} className="hover:bg-muted/40">
