...
const getStatusColor = (status: string) => {
    switch (status) {
        case "UP":
            return "bg-green-100 text-green-800 border-green-200 dark:bg-green-500/15 dark:text-green-400 dark:border-green-500/30"
        case "DOWN":
            return "bg-red-100 text-red-800 border-red-200 dark:bg-red-500/15 dark:text-red-400 dark:border-red-500/30"
        case "REDIRECT":
            return "bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-500/15 dark:text-blue-400 dark:border-blue-500/30"
        case "CLIENT_ERROR":
            return "bg-yellow-100 text-yellow-800 border-yellow-200 dark:bg-yellow-500/15 dark:text-yellow-400 dark:border-yellow-500/30"
        default:
            ...
            <Card className="bg-card border shadow-sm">
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
                        ...
                        <div className="flex flex-col gap-1.5">
                            <Label className="text-xs font-medium text-foreground">DNS Status</Label>
