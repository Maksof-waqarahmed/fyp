...
export default function LoginPage() {
  return (
    <div className="bg-zinc-950">
      <div className="min-h-screen md:max-w-[1440px] w-full m-auto grid lg:grid-cols-2">
        {/* Left side - Hero section with visual */}
        <div className="absolute top-20 -left-20 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
        <div className=" hidden lg:flex flex-col justify-between text-white p-12 overflow-hidden">
        ...
        <div className="relative flex items-center justify-center p-8">
          <div className="absolute bottom-20 right-1 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl"></div>
          <div className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_0_40px_rgba(255,255,255,0.08)] p-4 rounded-2xl">
            {/* Mobile logo */}
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-400">Start monitoring your deployments today</p>
            </div>
